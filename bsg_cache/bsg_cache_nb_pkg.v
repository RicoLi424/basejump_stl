...
package bsg_cache_nb_pkg;

  // These subopcodes are intended to match the low 4 bits of the
  //   corresponding bsg_cache_nb_pkt opcode, to simplify decoding
  ...
  typedef struct packed {
    ...
    logic atomic_op;
    bsg_cache_nb_amo_subop_e amo_subop;
  } bsg_cache_nb_decode_s;
